...
using SportsLeague.Domain.Interfaces.Services.SportsLeague.Domain.Interfaces.Services;
...
builder.Services.AddScoped<ITournamentTeamService, TournamentTeamRepository>();
